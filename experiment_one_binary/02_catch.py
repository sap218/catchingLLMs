...
corpus = "../spotify_user_reviews/exp1/DATASET_randomised_annotated.csv"
...
output_name = "../spotify_user_reviews/exp1/DATASET_randomised_annotated_catch.csv"
stats_output_name = "../results/exp1/catch_stats.txt"
...
for of_interest in categories: 
    ...
    COL_FOR_COUNT = "%s_catch" % of_interest
